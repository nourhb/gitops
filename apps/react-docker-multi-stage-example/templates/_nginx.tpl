...
*/}}
{{- define "react-docker-multi-stage-example.staticNginx" -}}
{{- or .Values.staticNginx (eq (int (.Values.service.targetPort | default 3000)) 8080) -}}
{{- end -}}

{{- define "react-docker-multi-stage-example.nginxVolumes" -}}
...
{{- define "react-docker-multi-stage-example.nginxVolumeMounts" -}}
- name: paas-nginx-conf
